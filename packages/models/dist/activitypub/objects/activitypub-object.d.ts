...
export type ActivityObject = VideoObject | AbuseObject | VideoCommentObject | CacheFileObject | PlaylistObject | WatchActionObject | string;
export type APObjectId = string | {
    id: string;
};
//# sourceMappingURL=activitypub-object.d.ts.map