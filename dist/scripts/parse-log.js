...
import { labelFormatter, mtimeSortFilesDesc } from '../core/helpers/logger.js';
...
const logger = winston.createLogger({
    transports: [
        new winston.transports.Console({
            ...
            stderrLevels: [],
            format: winston.format.combine(winston.format.splat(), labelFormatter(), winston.format.colorize(), loggerFormat)
        })
    ],
    exitOnError: true
});
...
async function getNewestFile(files, basePath) {
