...
async function deleteRemoteFiles() {
    ...
    const res = await askConfirmation(`${thumbnails.length.toLocaleString()} thumbnails and ${actorImages.length.toLocaleString()} avatars/banners can be locally deleted. ` +
...
//# sourceMappingURL=house-keeping.js.map