...
import { areValidationErrors, doesVideoChannelIdExist, doesVideoExist, doesVideoPlaylistExist, isValidPlaylistIdParam } from '../shared/index.js';
const videoPlaylistsAddValidator = getCommonPlaylistEditAttributes().concat([
    ...
    async (req, res, next) => {
        ...
        const body = req.body;
        if (body.videoChannelId && !await doesVideoChannelIdExist(body.videoChannelId, res))
            return cleanUpReqFiles(req);
