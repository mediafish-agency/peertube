...
async function up(utils) {
    ...
    {
        await utils.sequelize.query(`UPDATE "videoStreamingPlaylist" SET "playlistUrl" = NULL, "segmentsSha256Url" = NULL ` +
    ...
    {
        await utils.sequelize.query(`UPDATE "videoStreamingPlaylist" SET "playlistFilename" = 'master.m3u8', "segmentsSha256Filename" = 'segments-sha256.json'`);
    }
    {
        for (const column of ['playlistFilename', 'segmentsSha256Filename']) {
            const data = {
...
export { up, down };
//# sourceMappingURL=0655-streaming-playlist-filenames.js.map