...
async function downloadWebTorrentVideo(target, timeout) {
...
async function createTorrentAndSetInfoHashFromPath(videoOrPlaylist, videoFile, filePath) {
...
async function updateTorrentMetadata(videoOrPlaylist, videoFile) {
    const video = extractVideo(videoOrPlaylist);
