...
import { muxToMergeVideoFiles } from '../lib/video-file.js';
...
downloadRouter.use(DOWNLOAD_PATHS.GENERATE_VIDEO + ':id', downloadGenerateRateLimiter, optionalAuthenticate, asyncMiddleware(videosDownloadValidator), videosGenerateDownloadValidator, asyncMiddleware(downloadGeneratedVideoFile));
