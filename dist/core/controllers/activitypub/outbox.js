...
import { activityPubRateLimiter, asyncMiddleware, ensureIsLocalChannel, localAccountValidator, videoChannelsNameWithHostValidator } from '../../middlewares/index.js';
...
outboxRouter.get('/accounts/:name/outbox', activityPubRateLimiter, apPaginationValidator, localAccountValidator, asyncMiddleware(outboxController));
outboxRouter.get('/video-channels/:nameWithHost/outbox', activityPubRateLimiter, apPaginationValidator, asyncMiddleware(videoChannelsNameWithHostValidator), ensureIsLocalChannel, asyncMiddleware(outboxController));
export { outboxRouter };
