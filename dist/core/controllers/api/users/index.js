...
import { ensureCanModerateUser, usersAskResetPasswordValidator, usersBlockingValidator, usersResetPasswordValidator } from '../../../middlewares/validators/index.js';
...
usersRouter.post('/:id/block', authenticate, ensureUserHasRight(UserRight.MANAGE_USERS), asyncMiddleware(usersBlockingValidator), ensureCanModerateUser, asyncMiddleware(blockUser));
usersRouter.post('/:id/unblock', authenticate, ensureUserHasRight(UserRight.MANAGE_USERS), asyncMiddleware(usersBlockingValidator), ensureCanModerateUser, asyncMiddleware(unblockUser));
...
usersRouter.put('/:id', authenticate, ensureUserHasRight(UserRight.MANAGE_USERS), asyncMiddleware(usersUpdateValidator), ensureCanModerateUser, asyncMiddleware(updateUser));
usersRouter.delete('/:id', authenticate, ensureUserHasRight(UserRight.MANAGE_USERS), asyncMiddleware(usersRemoveValidator), ensureCanModerateUser, asyncMiddleware(removeUser));
