...
mySubscriptionsRouter.get('/me/subscriptions', authenticate, paginationValidator, userSubscriptionsSortValidator, setDefaultSort, setDefaultPagination, userSubscriptionListValidator, asyncMiddleware(getUserSubscriptions));
...
async function getUserSubscriptionVideos(req, res) {
    ...
    const apiOptions = await Hooks.wrapObject(Object.assign(Object.assign({}, query), { displayOnlyForFollower: {
            ...
            orLocalVideos: false
        }, nsfw: buildNSFWFilter(res, query.nsfw), user,
