...
export type MChannelSyncChannel = MChannelSync & Use<'VideoChannel', MChannelAccountDefault> & FunctionProperties<VideoChannelSyncModel>;
export type MChannelSyncFormattable = FunctionProperties<MChannelSyncChannel> & Use<'VideoChannel', MChannelFormattable> & MChannelSync;
export {};
