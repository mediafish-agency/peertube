...
export type MLocalVideoViewerVideo = MLocalVideoViewer & Use<'Video', MVideo>;
export type MLocalVideoViewerWithWatchSections = MLocalVideoViewer & Use<'Video', MVideo> & Use<'WatchSections', MLocalVideoViewerWatchSection[]>;
export {};
