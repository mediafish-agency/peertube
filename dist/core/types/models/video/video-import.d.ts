...
export type MVideoImportVideo = MVideoImport & Use<'Video', MVideo>;
type VideoAssociation = MVideoTag & MVideoAccountLight & MVideoThumbnail;
export type MVideoImportDefault = MVideoImport & Use<'User', MUser> & Use<'Video', VideoAssociation>;
export type MVideoImportDefaultFiles = MVideoImport & Use<'User', MUser> & Use<'Video', VideoAssociation & MVideoWithFile>;
