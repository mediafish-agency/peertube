...
import { PluginPlaylistPrivacyManager, PluginSettingsManager, PluginStorageManager, PluginTranscodingManager, PluginVideoCategoryManager, PluginVideoLanguageManager, PluginVideoLicenceManager, PluginVideoPrivacyManager, RegisterServerHookOptions, RegisterServerSettingOptions, ServerConfig, ThumbnailType_Type, VideoBlacklistCreate } from '@peertube/peertube-models';
import { ActorModel } from '../../models/actor/actor.js';
import { MUserDefault, MVideo, MVideoThumbnail, MVideoWithAllFiles, UserNotificationModelForApi } from '../models/index.js';
import { RegisterServerAuthExternalOptions, RegisterServerAuthExternalResult, RegisterServerAuthPassOptions } from './register-server-auth.model.js';
...
export type PeerTubeHelpers = {
    ...
    moderation: {
        ...
        unblockServer: (options: {
            byAccountId: number;
            hostToUnblock: string;
        }) => Promise<void>;
        blockAccount: (options: {
            byAccountId: number;
            handleToBlock: string;
        }) => Promise<void>;
        unblockAccount: (options: {
            byAccountId: number;
            handleToUnblock: string;
        }) => Promise<void>;
        blacklistVideo: (options: {
            videoIdOrUUID: number | string;
            createOptions: VideoBlacklistCreate;
        }) => Promise<void>;
        unblacklistVideo: (options: {
            videoIdOrUUID: number | string;
        }) => Promise<void>;
    };
    server: {
...
//# sourceMappingURL=register-server-option.model.d.ts.map