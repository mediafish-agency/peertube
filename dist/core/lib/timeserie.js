...
function buildGroupByAndBoundaries(startDateString, endDateString) {
...
export { buildGroupByAndBoundaries };
function buildGroupInterval(startDate, endDate) {
    ...
    if (diffSeconds >= 6 * aYear)
        return '6 months';
    if (diffSeconds >= 2 * aYear)
        return '1 month';
    if (diffSeconds >= 6 * aMonth)
        return '7 days';
    if (diffSeconds >= 2 * aMonth)
        return '2 days';
    if (diffSeconds >= 15 * aDay)
        return '1 day';
    if (diffSeconds >= 8 * aDay)
        return '12 hours';
    if (diffSeconds >= 4 * aDay)
        return '6 hours';
    if (diffSeconds >= 15 * anHour)
        return '1 hour';
    if (diffSeconds >= 180 * aMinute)
        return '10 minutes';
    return '1 minute';
}
//# sourceMappingURL=timeserie.js.map