...
function resolveImportPath(importPath) {
    ...
    const importPathTypingTs = importPath.replace(/\.[^/.]*js[^/.]*$/, (match) => match.replace("js", "d.ts"));
    const importPathWithExtensions = MODULE_EXTS.map((ext) => `${importPath}${ext}`);
    const possiblePaths = [importPath, importPathTypingTs, importPathTs, ...importPathWithExtensions];
