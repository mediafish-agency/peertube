...
class IdService {
    generateId(uploader) {
        const print = JSON.stringify(Object.assign(Object.assign({}, uploader.metadata), { type: uploader.constructor.name, endpoint: uploader.endpoint }));
...
class RetryHandler {
     ...
     */
    wait(time) {
        const ms = time || Math.min(Math.pow(2, (this.attempts - 1)) * this.config.minDelay, this.config.maxDelay);
...
class Uploader {
    ...
    upload() {
        return __awaiter(this, void 0, void 0, function* () {
            do {
                ...
                try {
                    this._token || (this._token = yield this.updateToken());
                    ...
                    if (this.offset === this.size) {
                        ...
                        this.stateChange(this);
                        yield this.retry.wait(this.getRetryAfterFromBackend() || this.retry.config.onBusyDelay);
                    }
                }
                catch (e) {
                    ...
                    switch (this.retry.kind(this.responseStatus)) {
                        ...
                        default:
                            ...
                            this.status = 'retry';
                            yield this.retry.wait(this.getRetryAfterFromBackend());
                    }
                }
    ...
    request(requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let req = {
                ...
                signal,
                headers: Object.assign(Object.assign({}, this.headers), requestOptions.headers),
            ...
            const ajaxRequestConfig = {
                method,
                headers: Object.assign(Object.assign({}, req.headers), headers),
                url,
                data: body,
                responseType: (_a = this.options.responseType) !== null && _a !== void 0 ? _a : this.responseType,
    ...
    getChunk(offset, size) {
        ...
        const start = (_a = offset !== null && offset !== void 0 ? offset : this.offset) !== null && _a !== void 0 ? _a : 0;
...
class UploaderX extends Uploader {
    ...
    getFileUrl() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.request({ method: 'POST', body, url: this.endpoint, headers });
...
class UploadxService {
    ...
    handleFiles(files, options = {}) {
        const instanceOptions = Object.assign(Object.assign(Object.assign({}, this.options), iosOverride), options);
    ...
    addUploaderInstance(file, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            uploader.uploadId = yield this.idService.generateId(uploader);
...
class UploadxDirective {
    ...
    ngOnInit() {
        const { multiple, allowedTypes } = Object.assign(Object.assign({}, this.uploadService.options), this.options);
...
class UploadxDropDirective {
    ...
    onDragOver(event) {
        var _a, _b, _c;
        this._stopEvents(event);
        if (((_b = (_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.items[0]) === null || _b === void 0 ? void 0 : _b.kind) === 'file') {
            if (((_c = this.fileInput) === null || _c === void 0 ? void 0 : _c.options.multiple) === false && event.dataTransfer.items.length > 1) {
    ...
    getFiles(event) {
        ...
        if (items === null || items === void 0 ? void 0 : items.length) {
            for (let i = 0; i < items.length; i++) {
                const item = items[i];
                if (item.kind === 'file' && !((_b = item.webkitGetAsEntry()) === null || _b === void 0 ? void 0 : _b.isDirectory)) {
