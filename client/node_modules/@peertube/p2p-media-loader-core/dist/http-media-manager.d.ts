...
declare class FilteredEmitter extends STEEmitter<"segment-start-load" | "segment-loaded" | "segment-error" | "segment-size" | "bytes-downloaded"> {
}
export declare class HttpMediaManager extends FilteredEmitter {
    readonly settings: {
    ...
    updatePriority: (segment: Segment) => void;
