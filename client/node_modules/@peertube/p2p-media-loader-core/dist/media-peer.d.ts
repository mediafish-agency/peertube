...
export declare class MediaPeer extends STEEmitter<"connect" | "close" | "data-updated" | "segment-start-load" | "segment-request" | "segment-absent" | "segment-loaded" | "segment-error" | "segment-timeout" | "segment-size" | "bytes-downloaded" | "bytes-uploaded"> {
    readonly peer: any;
    readonly settings: {
