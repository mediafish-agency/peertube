...
export interface LoaderInterface extends EventEmitter {
    on: ((eventName: string, listener: (...params: unknown[]) => void) => this) & ((eventName: Events.SegmentStartLoad, listener: (method: "http" | "p2p", segment: Segment) => void) => this) & ((eventName: Events.SegmentSize, listener: (segment: Segment, size: number) => void) => this) & ((eventName: Events.PieceBytesDownloaded | Events.PieceBytesUploaded, listener: (method: "http" | "p2p", segment: Segment, bytes: number, peerId?: string) => void) => this) & ((eventName: Events.SegmentLoaded, listener: (segment: Segment) => void) => this) & ((eventName: Events.SegmentError, listener: (segment: Segment, error: unknown) => void) => this) & ((eventName: Events.SegmentAbort, listener: (segment: Segment) => void) => this);
